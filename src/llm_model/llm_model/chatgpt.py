...
class ChatGPTNode(Node):
    ...
    def function_call(self, function_call_input):
        ...
        """
        # Ensure the robot name is 'yolobot'
        if "arguments" in function_call_input:
             function_call_input["arguments"] = function_call_input["arguments"].replace("turtle1","yolobot")
